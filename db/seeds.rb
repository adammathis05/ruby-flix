...
Movie.create!([
  ...
  },
  {
    ...
    released_on: "2024-12-25",
    rating: 'R',
    total_gross: 0,
    director: 'Robert Eggers',
    duration: '132 min',
    image_file_name: 'nosferatu.png'
  },
  {
  ...
  },
  {
    ...
    released_on: "2005-07-18",
    rating: 'PG-13',
    total_gross: 373_700_000,
    director: 'Christopher Nolan',
    duration: '140 min',
    image_file_name: 'batman-begins.png'
  },
  {
    title: "The Dark Knight",
    description:
    %{
      When a menace known as the Joker wreaks havoc and chaos on the people of Gotham City, Batman begins to tread a fine line between heroism and vigilantism. He must work together with Commissioner Gordon and Harvey Dent to put an end to the madness.
    }.squish,
    released_on: "2008-07-15",
    rating: "PG-13",
    total_gross: 1_006_000_000,
    director: "Christopher Nolan",
    duration: "152 min",
    image_file_name: "dark-knight.png"
  },
  {
    title: "Wonder Woman",
    description:
